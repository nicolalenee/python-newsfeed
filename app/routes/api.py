...
# update the post model by allowing upvotes on an article
...
# route to update the details of a post(need to query the corresponding record first)
...
# route for deleting posts (need to query the corresponding record first)
